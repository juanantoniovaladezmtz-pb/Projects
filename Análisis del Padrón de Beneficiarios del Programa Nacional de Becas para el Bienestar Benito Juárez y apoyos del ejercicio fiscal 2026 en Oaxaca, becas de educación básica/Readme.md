...
![Dashboard del análisis](images/dashboard.png)
...
Los registros cuyo valor fue igual a cero se mantuvieron dentro del conjunto de datos y fueron analizados como una categoría independiente.

Monto acumulado

El monto acumulado se calculó mediante la suma de los valores positivos de beca.

Di# Padrón de Becas de Educación Básica — Oaxaca 2026
